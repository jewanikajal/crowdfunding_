...
// Same as gov-chaincode.go — kept identical for fair comparison
// ============================================================
...
// ============================================================
// STRUCTS
// Identical to gov-chaincode — same payload, same structure
// ============================================================
...
// Investor registers on investment channel as well
// Approval status is synced via approvalHash passed from gov channel
// ============================================================

// RegisterStartup — mirrors gov channel registration for investment channel awareness
...
// RegisterInvestor — mirrors gov channel registration for investment channel
...
// RegisterValidator — mirrors gov channel for investment channel awareness
...
// Since investment-channel cannot query gov-channel directly,
// platform syncs validation status by calling these after gov approval
// ============================================================

// ValidateStartup — syncs startup approval status from gov channel
...
// ValidateInvestor — syncs investor approval status from gov channel
...
// ============================================================
// PROJECT SYNC
// Platform publishes approved project from gov channel to investment channel
// ApprovalHash from gov channel is passed here as proof of approval
// ============================================================

// CreateProject — platform syncs approved project metadata to investment channel
...
// ApproveProject — platform syncs approval hash from gov channel to investment channel
// approvalHash is the hash generated by gov-chaincode ApproveProject
func (c *InvestmentContract) ApproveProject(ctx contractapi.TransactionContextInterface,
	...
	project.ApprovalHash = approvalHash // proof from gov channel

	return put(ctx, "PROJECT_"+projectID, project)
}

// RejectProject — mirrors gov channel rejection on investment channel
...
// ApprovalHash verified on-chain to ensure gov channel approved it
...
// ReleaseFunds — Platform releases funds to startup
...
// Refund — 90% back to investor, 10% retained by platform
func (c *InvestmentContract) Refund(ctx contractapi.TransactionContextInterface,
	...
	_ = refundAmount // in real system triggers token transfer
...
// ResolveDispute — Enforces validator decision from gov channel on investment channel
// resolution comes from gov channel ResolveDispute outcome
