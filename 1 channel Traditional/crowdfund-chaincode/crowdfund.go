...
func (c *CrowdfundContract) CreateProject(ctx contractapi.TransactionContextInterface,
	...
	var startup Startup
	if err := json.Unmarshal(sBytes, &startup); err != nil {
		return err
	}
...
func (c *CrowdfundContract) Fund(ctx contractapi.TransactionContextInterface,
	...
	var investor Investor
	if err := json.Unmarshal(iBytes, &investor); err != nil {
		return err
	}
	...
	var project Project
	if err := json.Unmarshal(pBytes, &project); err != nil {
		return err
	}
...
func (c *CrowdfundContract) Refund(ctx contractapi.TransactionContextInterface,
	...
	if err := json.Unmarshal(iBytes, &investment); err != nil {
		return err
	}
...
func (c *CrowdfundContract) ResolveDispute(ctx contractapi.TransactionContextInterface,
	...
	var dispute Dispute
	if err := json.Unmarshal(dBytes, &dispute); err != nil {
		return err
	}
	...
	if resolution == "REFUND" {
		...
		project.Status = ProjectCancelled
		if err := put(ctx, "PROJECT_"+projectID, project); err != nil {
			return err
		}
	}
